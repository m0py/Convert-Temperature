# This Makefile is for the Convert::Temperature extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Convert/Temperature.pm]
#     AUTHOR => q[Filipe Dutra <mopy@cpan.org>]
#     NAME => q[Convert::Temperature]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/Convert/Temperature.pm]
...
MAKE = make
FULLEXT = Convert/Temperature
BASEEXT = Temperature
PARENT_NAME = Convert
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Convert/Temperature.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Convert/Temperature.pm
...
TO_INST_PM = lib/Convert/Temperature.pm

PM_TO_BLIB = lib/Convert/Temperature.pm \
...
DISTNAME = Convert-Temperature
DISTVNAME = Convert-Temperature-0.03
...
manifypods : pure_all  \
	lib/Convert/Temperature.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Convert/Temperature.pm $(INST_MAN3DIR)/Convert::Temperature.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:                Convert-Temperature' >> META_new.yml
	...
	$(NOECHO) $(ECHO) 'generated_by:        ExtUtils::MakeMaker version 6.38' >> META_new.yml
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/Convert/Temperature.pm blib/lib/Convert/Temperature.pm 
